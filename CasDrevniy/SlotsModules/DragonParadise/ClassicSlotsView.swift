...
struct ClassicSlotsView: View {
    @StateObject var viewModel =  ClassicSlotsViewModel()
    ...
    var body: some View {
        ZStack {
            ZStack(alignment: .top) {
                ...
                Image("classicSlotBg").resizable().ignoresSafeArea()
                                    ...
                                    .overlay {
                                        HStack {
                                            ...
                                            VStack {
                                                ...
                                                Text("\(UserDefaultsManager.shared.getGamesPlayed(forGame: 2))")
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                            ...
                                            VStack {
                                                ...
                                                Text("\(UserDefaultsManager.shared.getWins(forGame: 2))")
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                            ...
                                            VStack {
                                                ...
                                                Text("\(UserDefaultsManager.shared.getMaxWin(forGame: 2))")
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                            ...
                                            VStack {
                                                ...
                                                Text(String(format: "%.1f%%", UserDefaultsManager.shared.getWinPercentage(forGame: 2)))
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                                    .foregroundStyle(Color.white)
                                            }
                                            Spacer()
