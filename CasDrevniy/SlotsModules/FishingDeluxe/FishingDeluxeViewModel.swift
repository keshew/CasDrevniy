...
class FishingDeluxeViewModel: ObservableObject {
    let contact = FishingDeluxeModel()
    @Published var slots: [[String]] = []
    @Published var coin =   UserDefaultsManager.shared.coins
    @Published var bet = 5
    let allFruits = ["fish1", "fish2", "fish3","fish4", "fish5", "fish6"]
    ...
    let symbolArray = [
        Symbol(image: "fish1", value: "100"),
        Symbol(image: "fish2", value: "50"),
        Symbol(image: "fish3", value: "20"),
        Symbol(image: "fish4", value: "15"),
        Symbol(image: "fish5", value: "5"),
        Symbol(image: "fish6", value: "3")
    ]
    ...
    func spin() {
        UserDefaultsManager.shared.incrementGamesPlayed(forGame: 3)
    ...
    func checkWin() {
        ...
        if totalWin != 0 {
            ...
            coin = UserDefaultsManager.shared.coins
            UserDefaultsManager.shared.incrementWins(forGame: 3)
            UserDefaultsManager.shared.updateMaxWin(forGame: 3, winAmount: win)
        }
    }
}
