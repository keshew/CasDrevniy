...
struct FishingDeluxeView: View {
    @StateObject var viewModel =  FishingDeluxeViewModel()
    ...
    var body: some View {
        ZStack {
            ZStack(alignment: .top) {
                ...
                Image("fishBg").resizable().ignoresSafeArea()
            ...
            VStack(spacing: 7) {
                ...
                ScrollView(showsIndicators: false) {
                    VStack {
                        Rectangle()
                            .fill(Color(red: 0/255, green: 38/255, blue: 65/255).opacity(0.95))
                            .frame(width: 450, height: 250)
                            .overlay {
                                RoundedRectangle(cornerRadius: 12)
                                    .stroke(Color(red: 0/255, green: 238/255, blue: 255/255), lineWidth: 2)
                                    .overlay {
                                        VStack(spacing: 15) {
                                            VStack(spacing: 5) {
                                            ...
                                            HStack {
                                                ...
                                                Button(action: {
                                                    ...
                                                    Rectangle()
                                                        .fill(Color(red: 0/255, green: 238/255, blue: 255/255))
                                                        .overlay {
                                                            HStack {
                                    ...
                                    .overlay {
                                        HStack {
                                            ...
                                            VStack {
                                                ...
                                                Text("\(UserDefaultsManager.shared.getGamesPlayed(forGame: 3))")
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                            ...
                                            VStack {
                                                ...
                                                Text("\(UserDefaultsManager.shared.getWins(forGame: 3))")
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                            ...
                                            VStack {
                                                ...
                                                Text("\(UserDefaultsManager.shared.getMaxWin(forGame: 3))")
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                            ...
                                            VStack {
                                                ...
                                                Text(String(format: "%.1f%%", UserDefaultsManager.shared.getWinPercentage(forGame: 3)))
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                                    .foregroundStyle(Color.white)
                                            }
                                            Spacer()
