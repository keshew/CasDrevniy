...
struct DragonParadiseView: View {
    @StateObject var viewModel =  DragonParadiseViewModel()
    ...
    var body: some View {
        ZStack {
            ZStack(alignment: .top) {
                ...
                Image("bgSlot2").resizable().ignoresSafeArea()
            ...
            VStack(spacing: 7) {
                ...
                ScrollView(showsIndicators: false) {
                    VStack {
                        Rectangle()
                            .fill(Color(red: 131/255, green: 110/255, blue: 1/255).opacity(0.95))
                            .frame(width: 450, height: 250)
                            .overlay {
                                RoundedRectangle(cornerRadius: 12)
                                    .stroke(Color(red: 255/255, green: 255/255, blue: 0/255), lineWidth: 2)
                                    .overlay {
                                        VStack(spacing: 15) {
                                            VStack(spacing: 5) {
                                                    ...
                                                    Rectangle()
                                                        ...
                                                        .overlay {
                                                            RoundedRectangle(cornerRadius: 6)
                                                                .stroke(Color(red: 255/255, green: 215/255, blue: 0/255), lineWidth: 2)
                                                                .overlay {
                                                                    HStack {
                                    ...
                                    .overlay {
                                        HStack {
                                            ...
                                            VStack {
                                                ...
                                                Text("\(UserDefaultsManager.shared.getGamesPlayed(forGame: 4))")
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                            ...
                                            VStack {
                                                ...
                                                Text("\(UserDefaultsManager.shared.getWins(forGame: 4))")
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                            ...
                                            VStack {
                                                ...
                                                Text("\(UserDefaultsManager.shared.getMaxWin(forGame: 4))")
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                            ...
                                            VStack {
                                                ...
                                                Text(String(format: "%.1f%%", UserDefaultsManager.shared.getWinPercentage(forGame: 4)))
                                                    .font(.custom("PaytoneOne-Regular", size: 14))
                                                    .foregroundStyle(Color.white)
                                            }
                                            Spacer()
